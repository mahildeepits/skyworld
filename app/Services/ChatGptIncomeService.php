...
class ChatGptIncomeService {
    protected $income = 0;
    protected $users; // All users in memory
    protected $usersByParent = [];

    public function communityBonus() {
        $this->users = User::with(['agentCategory', 'achieved_level'])
    ...
    protected function settleLayerCommission($user, $children = null, $level = 1) {
        ...
        foreach ($children as $child) {
            ...
            $childBonusRate = $child->achieved_level->community_bonus_rate ?? 0;
